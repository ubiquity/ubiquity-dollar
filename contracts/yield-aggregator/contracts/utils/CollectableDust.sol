...
abstract contract CollectableDust is ICollectableDust {
  ...
  function _addProtocolToken(address _token) internal {
    require(!_protocolTokens.contains(_token), 'collectable-dust::token-is-part-of-the-protocol');
    _protocolTokens.add(_token);
    emit ProtocolTokenAdded(_token);
  }

  function _removeProtocolToken(address _token) internal {
    require(_protocolTokens.contains(_token), 'collectable-dust::token-not-part-of-the-protocol');
