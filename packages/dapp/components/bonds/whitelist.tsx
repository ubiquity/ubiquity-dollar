      ...
      <div>
        ...
        <div>
          {(() => {
            switch (status) {
              case "not-connected":
                return <h2>Connect your wallet to check if you are on the whitelist</h2>;
              case "loading":
                return (
                  <>
                    <div></div>
              ...
              case "whitelisted":
                return (
                  <div>
                    ...
                    <p>You may mint a UbiquiStick and use the exclusive pools</p>
                  </div>
                );
              case "not-whitelisted":
                return (
                  <div>
                    ...
                    <p>In order to participate you need to be on the whitelist</p>
