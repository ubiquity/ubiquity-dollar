...
// ARTIFACTS
import _DebtCoupon from "@ubiquity/contracts/out/credit-nft.sol/CreditNft.json";
import _DebtCouponManager from "@ubiquity/contracts/out/credit-nft-manager-facet.sol/CreditNftManagerFacet.json";
import _DollarMintCalculator from "@ubiquity/contracts/out/dollar-mint-calculator-facet.sol/DollarMintCalculatorFacet.json";
import _ERC1155Ubiquity from "@ubiquity/contracts/out/erc-1155-ubiquity.sol/ERC1155Ubiquity.json";
import _ICouponsForDollarsCalculator from "@ubiquity/contracts/out/i-credit-nft-redemption-calculator.sol/ICreditNftRedemptionCalculator.json";
import _IUARForDollarsCalculator from "@ubiquity/contracts/out/i-credit-redemption-calculator.sol/ICreditRedemptionCalculator.json";
import _ICurveFactory from "@ubiquity/contracts/out/i-curve-factory.sol/ICurveFactory.json";
import _IJar from "@ubiquity/contracts/out/i-jar.sol/IJar.json";
import _IMetaPool from "@ubiquity/contracts/out/i-meta-pool.sol/IMetaPool.json";
import _SimpleBond from "@ubiquity/contracts/out/simple-bond.sol/SimpleBond.json";
import _Staking from "@ubiquity/contracts/out/staking-facet.sol/StakingFacet.json";
import _StakingToken from "@ubiquity/contracts/out/staking-share.sol/StakingShare.json";
import _SushiSwapPool from "@ubiquity/contracts/out/sushi-swap-pool.sol/SushiSwapPool.json";
import _TWAPOracle from "@ubiquity/contracts/out/twap-oracle-dollar-3-pool-facet.sol/TWAPOracleDollar3poolFacet.json";
import _UbiquiStick from "@ubiquity/contracts/out/ubiqui-stick.sol/UbiquiStick.json";
import _UbiquiStickSale from "@ubiquity/contracts/out/ubiqui-stick-sale.sol/UbiquiStickSale.json";
import _MasterChefV2 from "@ubiquity/contracts/out/chef-facet.sol/ChefFacet.json";
import _Credit from "@ubiquity/contracts/out/ubiquity-credit-token.sol/UbiquityCreditToken.json";
import _UbiquityManager from "@ubiquity/contracts/out/manager-facet.sol/ManagerFacet.json";
import _Dollar from "@ubiquity/contracts/out/ubiquity-dollar-token.sol/UbiquityDollarToken.json";
import _UbiquityFormulas from "@ubiquity/contracts/out/staking-formulas-facet.sol/StakingFormulasFacet.json";
import _Governance from "@ubiquity/contracts/out/ubiquity-governance-token.sol/UbiquityGovernanceToken.json";
