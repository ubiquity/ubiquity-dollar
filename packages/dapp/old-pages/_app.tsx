...
import AppContextProvider from "old-components/lib/AppContextProvider";
import Background from "../old-components/layout/Background";
...
export default function Ubiquity({ Component, pageProps }: AppProps) {
  return (
    <>
      {GenerateHead()}
      <AppContextProvider>
