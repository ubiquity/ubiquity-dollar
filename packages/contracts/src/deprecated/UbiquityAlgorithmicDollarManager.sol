...
contract UbiquityAlgorithmicDollarManager is AccessControl {
    ...
    function setDebtCouponAddress(
        address _debtCouponAddress
    ) external onlyAdmin {
        debtCouponAddress = _debtCouponAddress;
    }

    function setIncentiveToUAD(
        address _account,
    ...
    function setUARCalculatorAddress(
        address _uarCalculatorAddress
    ) external onlyAdmin {
        uarCalculatorAddress = _uarCalculatorAddress;
    }

    function setCouponCalculatorAddress(
        address _couponCalculatorAddress
    ) external onlyAdmin {
    ...
    function setBondingShareAddress(
        address _bondingShareAddress
    ) external onlyAdmin {
     ...
     */
    function setBondingContractAddress(
    ...
    */
    ...
    function getExcessDollarsDistributor(
        address _debtCouponManagerAddress
