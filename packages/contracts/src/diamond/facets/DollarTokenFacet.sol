...
contract DollarTokenFacet is Modifiers, ERC20ForFacet, IERC20Ubiquity {
    ...
    function setIncentiveContract(
        ...
        LibDollar.setIncentiveContract(account, incentive);
    }
    ...
    function permit(
        ...
        LibDollar.permit(owner, spender, value, deadline, v, r, _s);
    }
    ...
    function burn(uint256 amount) external whenNotPaused {
        LibDollar.burn(_msgSender(), amount);
    }
    ...
    function mint(
        ...
        LibDollar.mint(to, amount);
    }

    function nonces(address sender) external view returns (uint256) {
        return LibDollar.ubiquityDollarStorage().nonces[sender];
    }

    function DOMAIN_SEPARATOR() external view returns (bytes32) {
        return LibDollar.ubiquityDollarStorage().DOMAIN_SEPARATOR;
    }
}
