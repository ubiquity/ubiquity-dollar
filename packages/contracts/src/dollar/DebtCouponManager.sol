...
contract DebtCouponManager is ERC165, IERC1155Receiver {
    ...
    function redeemCoupons(uint256 id, uint256 amount) public returns (uint256) {
        ...
        require(
            autoRedeemToken.totalSupply() <= uAD.balanceOf(address(this)), "There aren't enough uAD to redeem currently"
        );
    ...
    function mintClaimableDollars() public {
        ...
        uint256 totalMintableDollars =
            IDollarMintingCalculator(manager.dollarMintingCalculatorAddress()).getDollarsToMint();
