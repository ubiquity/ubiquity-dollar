...
contract ERC1155SetUri is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    {
        require(
            account != address(0), "ERC1155: address zero is not a valid owner"
        );
    ...
    function _safeTransferFrom(
        ...
        require(
            fromBalance >= amount, "ERC1155: insufficient balance for transfer"
        );
        unchecked {
        ...
        virtual
    {
        ...
        _doSafeTransferAcceptanceCheck(
            operator, address(0), to, id, amount, data
        );
    }
