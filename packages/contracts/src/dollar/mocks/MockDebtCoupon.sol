...
contract MockDebtCoupon is ERC1155 {
    ...
    event BurntCoupons(address indexed owner, uint256 amount, uint256 expiryBlockNumber);
    ...
    function mintCoupons(address receiver, uint256 couponsToMint, uint256 expiryBlockNumber) public {
        _balances[receiver][expiryBlockNumber] = _balances[receiver][expiryBlockNumber] + couponsToMint;
