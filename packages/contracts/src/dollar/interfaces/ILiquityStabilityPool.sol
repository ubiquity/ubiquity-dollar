...
interface ILiquityStabilityPool {
    ...
    /// @notice Deposits LUSD into the Stability Pool and optionally claims rewards to a front end
    /// @param _amount Amount of LUSD to deposit
    ...
    /// @notice Gets the depositor's total stake (front end stake if applicable)
    /// @param _depositor Address of the depositor
