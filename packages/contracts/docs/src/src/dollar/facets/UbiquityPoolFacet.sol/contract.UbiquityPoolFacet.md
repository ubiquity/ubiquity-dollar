# UbiquityPoolFacet
[Git Source](https://github.com/ubiquity/ubiquity-dollar/blob/ffeaddd1fd1406665ab0a20ce038bfd2170d6f36/src/dollar/facets/UbiquityPoolFacet.sol)
...
```solidity
function toggleMRB(uint256 collateralIndex, uint8 toggleIndex) external onlyAdmin;
```
**Parameters**
