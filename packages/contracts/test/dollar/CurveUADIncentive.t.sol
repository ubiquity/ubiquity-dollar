...
contract CurveUADIncentiveTest is LocalTestHelper {
    ...
    function test_incentivize_buy() public {
        address stableSwapPoolAddress = UbiquityAlgorithmicDollarManager(uADManagerAddress).stableSwapMetaPoolAddress();
        ...
        vm.prank(admin);
        CurveUADIncentive(curveIncentiveAddress).setExemptAddress(mockReceiver, true);
        ...
        vm.startPrank(admin);
        CurveUADIncentive(curveIncentiveAddress).setExemptAddress(mockReceiver, false);
    ...
    function test_incentivize_sell() public {
        ...
        vm.prank(admin);
        CurveUADIncentive(curveIncentiveAddress).setExemptAddress(mockSender, true);
        ...
        vm.startPrank(admin);
        CurveUADIncentive(curveIncentiveAddress).setExemptAddress(mockSender, false);
    ...
    function test_setExemptAddress() public {
        ...
        CurveUADIncentive(curveIncentiveAddress).setExemptAddress(exemptAddress, true);

        assertEq(CurveUADIncentive(curveIncentiveAddress).isExemptAddress(exemptAddress), false);
        vm.prank(admin);
        vm.expectEmit(true, true, false, true);
        emit ExemptAddressUpdate(exemptAddress, true);
        CurveUADIncentive(curveIncentiveAddress).setExemptAddress(exemptAddress, true);
        assertEq(CurveUADIncentive(curveIncentiveAddress).isExemptAddress(exemptAddress), true);
    }
    ...
    function test_switchSellPenalty() public {
        ...
        assertEq(CurveUADIncentive(curveIncentiveAddress).isSellPenaltyOn(), true);
        vm.prank(admin);
        CurveUADIncentive(curveIncentiveAddress).switchSellPenalty();
    ...
    function test_switchBuyIncentive() public {
        ...
        assertEq(CurveUADIncentive(curveIncentiveAddress).isBuyIncentiveOn(), true);
        vm.prank(admin);
        CurveUADIncentive(curveIncentiveAddress).switchBuyIncentive();
        assertEq(CurveUADIncentive(curveIncentiveAddress).isBuyIncentiveOn(), false);
    }
}
