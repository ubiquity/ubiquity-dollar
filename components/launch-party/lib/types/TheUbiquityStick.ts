...
export interface TheUbiquityStickInterface extends utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "burn(uint256)": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "gold(uint256)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "gold", values: [BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: "tokenIdNext", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "tokenIdNext", data: BytesLike): Result;
...
export interface TheUbiquityStick extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TheUbiquityStickInterface;
  ...
  functions: {
    ...
    gold(arg0: BigNumberish, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    setTokenURI(ntype: BigNumberish, tokenURI_: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
    ...
    tokenIdNext(overrides?: CallOverrides): Promise<[BigNumber]>;

    tokenOfOwnerByIndex(owner: string, index: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;

    tokenURI(tokenId: BigNumberish, overrides?: CallOverrides): Promise<[string] & { uri: string }>;
  ...
  callStatic: {
    ...
    setTokenURI(ntype: BigNumberish, tokenURI_: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    gold(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    setTokenURI(ntype: BigNumberish, tokenURI_: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    gold(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    setMinter(minter_: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    setTokenURI(ntype: BigNumberish, tokenURI_: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
    ...
    tokenIdNext(overrides?: CallOverrides): Promise<PopulatedTransaction>;
